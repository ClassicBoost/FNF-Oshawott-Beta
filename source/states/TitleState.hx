...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.data.checkForUpdates && !closedState) {
			...
			http.onData = function (data:String)
			{
				...
				var curVersion:String = Main.foreverVersion.trim();
	...
	{
		#if MODS_ALLOWED
		var firstArray:Array<String> = Mods.mergeAllTextsNamed('introText.txt', Paths.getPreloadPath());
		#else
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 4:
					addMoreText('OwenTheMc', 40);
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Psych Forever', 'by'], -40);
				case 8:
					addMoreText('Raylo', -40);
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
				case 10:
