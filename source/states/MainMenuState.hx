...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 55, 0, '', 12);
		versionShit.text += "Psych Forever Engine v" + Main.foreverVersion;
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://docs.google.com/document/d/1V2_rVXUa3V4kC1qh3BHQBz3PUp2k5NUGWAi7p9Bg-Vk/edit?usp=sharing');
				}
				else
				{
					selectedSomethin = true;
